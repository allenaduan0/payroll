			...
			<div class="col-lg-12">
				...
				<div class="card">
					<div class="card-header" style="background: #FCAF38;">
						...
						<button class="btn btn-sm btn-block col-md-3 float-right" style="background: #50A3A4;color:WHITE;" type="button" id="new_attendance_btn"><span class="fa fa-plus"></span> Add Attendance</button>
					</div>
					<div class="card-body">
